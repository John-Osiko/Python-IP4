...
def subscribe():
    ...
    mail_message("Subscribed to Ace-Blog","email/email_user",new_subscriber.email,new_subscriber=new_subscriber)
...
def delete_post(blog_id):
    ...
    if blog.user != current_user:
        abort(403)
    blog.delete()
    flash("Your Blog has been deleted succesfully!")
    return redirect(url_for('main.index'))
